<template>
  <div class="bg-white rounded-2xl shadow-md overflow-hidden hover:shadow-2xl transition duration-500 transform hover:-translate-y-2 border border-purple-50 group">
    <div class="h-72 overflow-hidden bg-gray-100 relative">
      <img :src="image" :alt="title" class="w-full h-full object-cover transition duration-500 group-hover:scale-110" />
